...
public class OrderServiceV4Impl implements OrderService {
    ...
    public void saveOrder(OrderParams orderParams) {
        ...
        Product product = restTemplate.getForObject("http://" + productServer + "/product/get/" + orderParams.getUserId(), Product.class);
        if (product == null) {
        ...
        Result result = restTemplate.getForObject("http://" + productServer + "/product/update_count/" + orderParams.getProductId() + "/" + orderParams.getCount(),
                Result.class);
        assert result != null;
